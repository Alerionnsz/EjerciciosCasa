...
//*************		Grupo: 02	Ejercicio de Casa									******//
//*************			Circuito volador del carro					******//
//*********************      con T o t iniciamos la animación ***************************************//
...
void animacion()
{
	...
	if (circuito3) //comienza maquina de estados
	{
		if (recorrido1)//comienza estado A
		{
			movKitZ--;
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 't':		//  
		case 'T':
			circuito3 ^= true; //Activamos/desactivamos la animacíon
			g_fanimacion = false;
			break;
