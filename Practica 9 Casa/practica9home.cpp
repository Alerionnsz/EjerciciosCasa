...
//*************				Práctica 09  Grupo_02 Ejercicio de CASA						******//
//*************		Visual Studio 2017 ------- Mesa de ajedrez	con sillas y respaldos texturizados con transparencia								******//
//************************************************************//
//************************************************************//
#include "texture.h"
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	sillaizq.LoadTGA("sillaizq.tga");
	sillaizq.BuildGLTexture();
	sillaizq.ReleaseImage();

	sillader.LoadTGA("sillader.tga");
	sillader.BuildGLTexture();
	sillader.ReleaseImage();
}
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(5.9, 1.25, -2);
	glColor3f(1.0, 1.0, 1.0);
	glRotatef(-90, 0, 1, 0);
	glScalef(1.0, 4, 0.2);
	prisma(sillader.GLindex, sillader.GLindex);
	glPopMatrix();
	//// RESPALDO IZQ 
	...
	glRotatef(-90, 0, 1, 0);
	glScalef(1.0, 4, 0.2);
	prisma(sillaizq.GLindex, sillaizq.GLindex);
	glPopMatrix();
